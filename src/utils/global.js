export let itemData = [
    {title: "Algorithmically Fair?", page: "Algorithmically-Fair", year: 2022, src: "/assets/portfolio/algorithmically-fair/image1.jpg", alt: "Three dimensional data visualization comparing black recidivism rates to white recidivism rates", tags: ["#adobe-illustrator", "#acrylic", "#public-policy", "#data-art", "#data-physicalization", "#data-visualization", "#r", "#iiba-longlist-2023"]},
    {title: "Banca Intesa Knowledge Network", page: "Billy", year: 2022, src: "/assets/portfolio/banca-intesa-knowledge-network/analyze-by-area-domain-gender.png", alt:"Image of network analysis across a knowledge network by area, domain, and gender", tags: ["#d3-js", "#pixi-js", "#react", "#data-visualization", "#interaction-design", "#python", "#iiba-longlist-2022"]},
    {title: "Billy", page: "Billy", year: 2022, src: "/assets/portfolio/billy/Images/HiFi-V2/Login (1).jpg", alt:"Image of login page for digitial wallet called Billy", tags: ["#interaction-design", "#user-interface", "#figma", "#user-experience", "#user-interaction"]},
    ...
    {title: "Banca Intesa Processes", page: "Banca-Intesa-Processes", year: "2023", src: "/assets/portfolio/banca-intesa-processes/circle-packing-full-screen.png", alt: "A data visualization showing multiple levels of organizational hierarchy.", tags: ["#d3-js", "#pixi-js", "#react", "#data-visualization", "#interaction-design", "#python", "#iiba-longlist-2023"]},
    ...
    {title: "Drawings Collection", page: "Drawings-Collection", year: 2014, src: "/assets/portfolio/drawings/figure/20201115_164033.jpg", alt:"Sleeping person in conte.", tags: ["#collection", "#charcoal", "#conte", "#drawing", "#fine-art"]},
    ...
    {title: "Ceramics Collection", page: "Ceramics-Collection", year: 2020, src: "/assets/portfolio/ceramics/20201028_074420.jpg", alt: "Serving bowl in Spodumene and Turner White", tags: ["#ceramics", "#collection", "#fine-art"]},
    ...
    {title: "Tutor Match", page: "Tutor-Match", year: 2022, src: "/assets/portfolio/tutor-match/Images/Wireframe/20221213/Main2.jpg", alt:"Image of user interface design for homescreen of tutor match", tags: ["#interaction-design", "#user-interface", "#figma",  "#user-experience", "#user-interaction"]},
